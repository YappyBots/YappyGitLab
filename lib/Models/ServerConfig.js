...
class ServerConfig {
  ...
  */
  ...
  /**
  * Delete guild config
  * @param {external:Guild|String} guildID Guild config to delete
  * @return {Promise<ServerConfig>}
  */
  deleteGuild(guildID) {
  ...
  * @param {external:Guild} guildID Guild to add config of
  * @return {Promise<ServerConfig>}
  */
  add(guild) {
    ...
    return serverConfig.create(conf).then(() => {
      this._data.set(conf.channelId, new ServerConfigItem(this, conf));
      return Promise.resolve(this);
    });
  }
  ...
  * @param {external:Guild|String} guildID Guild id to change config of
  ...
  */
  ...
  /**
  * Has guild conf
  * @param {external:Guild|String} guildID Guild id to check if has config
  * @return {Boolean}
  */
  has(guildID) {
    if (guildID.id) guildID = guildID.id;
