...
class GitlabInitCommand extends Command {
    ...
    _successMessage(repo, hasEmbed) {
        const embed = new this.embed()
            ...
            .setDescription(
                [
                    'The repository must a webhook pointing to <https://yappy.dsev.dev/gitlab>',
                    '_Note that this is a \*new\* url -- make sure to update any old hooks in other repos if needed._',
                    !hasEmbed
