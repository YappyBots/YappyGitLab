...
class Client extends DiscordClient {
  ...
  runCommand(msg) {
    ...
    if (!msg.content.startsWith(this.prefix) && !msg.content.startsWith(this.user.toString()) && !msg.content.startsWith(prefix)) return false;

    let content = msg.content.startsWith(this.prefix) || msg.content.startsWith(prefix) ? msg.content.replace(this.prefix, '').replace(prefix, '') : msg.content.replace(`${this.user.toString()} `, '');
