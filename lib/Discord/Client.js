...
class Client extends DiscordClient {
  ...
  runCommand(msg) {
    if (!msg.content.startsWith(this.prefix) && !msg.content.startsWith(this.user.toString())) return false;

    let content = msg.content.startsWith(this.prefix) ? msg.content.replace(this.prefix, '') : msg.content.replace(`${this.user.toString()} `, '');
