...
class Log {
  constructor() {
    ...
    // bugsnag.register(process.env.YAPPY_GITLAB_BUGSNAG, {
    ...
    //   sendCode: true,
    // });
    // this.raven = new raven.Client(process.env.YAPPY_GITLAB_SENTRY, {
    ...
    this._token = process.env.DISCORD_TESTING_BOT_TOKEN || process.env.YAPPY_GITLAB_DISCORD;
